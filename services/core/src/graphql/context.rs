...
use sea_orm::{AccessMode, ColumnTrait, DatabaseConnection, DatabaseTransaction, EntityTrait, IsolationLevel, QueryFilter, TransactionTrait};
...
impl GQLRequestContext {
    pub async fn new(
        ...
        let database_ro = web_context.db.db_ro.unwrap_or_else(|| web_context.db.db.clone());
        ...
        let txn_ro = database_ro
            ...
            .await.change_context(CreateGQLRequestContextError::CreateReadTransactionError)?;
